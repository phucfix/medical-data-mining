"""
Script test model Qwen LoRA trên tệp Test_sample.v1.0.csv
"""
...
OUTPUT_FILE = BASE_DIR / "data" / "test_sample_results.json"
...
def evaluate_on_test_sample():
    """Đánh giá model trên Test_sample.v1.0.csv"""
    print("=" * 60)
    print("TESTING QWEN LORA ON Test_sample.v1.0.csv")
    print("=" * 60)
